<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Container.Master" CodeBehind="UsuarioGrupo.aspx.cs" Inherits="UsuarioGrupo" %>
                ...
                <table id="tblAsignarContenido">
                    ...
                    <div id="divAsignarPermisosDisponiblesContenedor">
                        <div id="divAsignarFondoRolesDisponibles">
                            <label class="asignarTitulo">Usuarios por Grupo</label>
                        </div>  
                        <br /><br />                        
                        <label class="asignarSubTitulo">Grupo</label> &nbsp;                        
                        <asp:DropDownList ID="ddlGrupos" runat="server"  Width="228px" OnSelectedIndexChanged="ddlGrupos_SelectedIndexChanged" AutoPostBack="True" AppendDataBoundItems="True" >
                            <asp:ListItem Value="-1">--- Seleccione un Grupo ---</asp:ListItem>
                        </asp:DropDownList>
                        <br /><br />
                    </div>
                        ...
                        <td class="tdAsignarOpciones" align="left" valign="top">
                            <asp:Panel ID="PanelDisponibles" runat="server" BorderColor="white" BorderWidth="2" Width="100%" Height="100%" ScrollBars="None">
                                <table class="tblAsignarDisponibles">
                                    <tr>
                                        <td class="tdAsignar">
                                            <asp:Label runat="server" ID="lblDisponibles" Style="color: #ffffff; font-family: Tahoma; font-size: 15px; font-weight: bold;">Usuarios Disponibles</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Panel runat="server" ID="panel1" Height="400px" ScrollBars="Auto">
                                                <asp:GridView ID="GridDisponibles" runat="server" CssClass="mainGridView" AutoGenerateColumns="False" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField Visible="false" HeaderText="USUARIO">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblID_USUARIO" runat="server" Text='<%# Eval("IdUsuario") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="CodUsuario" HeaderText="Código Usuario" ItemStyle-Width="100px">
                                                            <HeaderStyle ForeColor="Black" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="DesUsuario" HeaderText="Nombre Usuario">
                                                            <HeaderStyle ForeColor="Black" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="Activo" ItemStyle-Width="45px">
                                                            <ItemTemplate>
                        ...
                        <td align="right" class="tdAsignarOpciones" valign="top">
                            <asp:Panel ID="PanelAsignados" runat="server" BorderColor="white" BorderWidth="2" Width="100%" Height="100%" ScrollBars="None">
                                <table class="tblAsignarDisponibles">
                                    <tr>
                                        <td class="tdAsignar">
                                            <asp:Label runat="server" ID="lblAsignados" CssClass="asignarTitulo">Usuarios Asignados</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
