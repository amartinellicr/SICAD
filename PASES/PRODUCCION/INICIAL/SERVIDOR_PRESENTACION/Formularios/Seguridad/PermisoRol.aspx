<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Container.Master" CodeBehind="PermisoRol.aspx.cs" Inherits="RolPermiso" %>
                            ...
                            <center>
                                <div id="divAsignarPermisosDisponiblesContenedor">
                                    <div id="divAsignarFondoRolesDisponibles">
                                        <label class="asignarTitulo">Permisos por Roles</label>
                                    </div>  
                                    <br /><br />                        
                        ...
                        <td class="tdAsignarOpciones" align="left" valign="top">
                            <asp:Panel ID="PanelDisponibles" runat="server" BorderColor="white" BorderWidth="2" Width="100%" Height="100%" ScrollBars="None">
                                <table class="tblAsignarDisponibles">
                                    <tr>
                                        <td class="tdAsignar">
                                            <asp:Label runat="server" ID="lblDisponibles" CssClass="asignarTitulo">Permisos Disponibles</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                                ...
                                                <asp:GridView ID="GridDisponibles" runat="server" CssClass="mainGridView" AutoGenerateColumns="False" Width="100%">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCodSiteMap" runat="server" Text='<%# Eval("CodSiteMap") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="Titulo" HeaderText="Permiso">
                                                            <HeaderStyle ForeColor="Black" Width="175px" Wrap="TRUE" />
                                                            <ItemStyle HorizontalAlign="Left" Width="175px" Wrap="TRUE" />
                                                        </asp:BoundField>
                                                        <asp:TemplateField HeaderText="Incluir" ItemStyle-Width="40px">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkIncluir" runat="server" Checked='<%# Bind("Incluir") %>' Enabled="false" />
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Editar" ItemStyle-Width="40px">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkActualizar" runat="server" Checked='<%# Bind("Actualizar") %>' Enabled="false" />
                                                            </ItemTemplate>
                                                            <HeaderStyle ForeColor="Black" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Borrar" ItemStyle-Width="40px">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkEliminar" runat="server" Checked='<%# Bind("Eliminar") %>' Enabled="false" />
                                                            </ItemTemplate>
                                                            <HeaderStyle ForeColor="Black" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                        ...
                        <td align="right" class="tdAsignarOpciones" valign="top">
                            <asp:Panel ID="PanelAsignados" runat="server" BorderColor="white" BorderWidth="2" Width="100%" Height="100%" ScrollBars="None">
                                <table class="tblAsignarDisponibles">
                                    <tr>
                                        <td class="tdAsignar">
                                            <asp:Label runat="server" ID="lblAsignados" CssClass="asignarTitulo">Permisos Asignados</asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
