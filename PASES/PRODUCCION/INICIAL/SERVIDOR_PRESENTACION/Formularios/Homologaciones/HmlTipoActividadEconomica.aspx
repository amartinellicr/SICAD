<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Container.Master" CodeBehind="HmlTipoActividadEconomica.aspx.cs" Inherits="HmlTipoActividadEconomica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="gridsHml" class="gridsArea">
        ...
        <div id="divGridHomologacion">
            <uc1:MasterGrid ID="MasterGrid2" runat="server" />
        </div>
    </div>
