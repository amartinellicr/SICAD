...
<head id="Head1" runat="server">
    <title>SICAD - Página Error</title>
                        ...
                        <td colspan="3">
                            <div id="header">
                                <table style="width: 100%; height: 60px;">
                                    <tr>
                                        <td>
                                            <asp:Image ID="imgError" runat="server" ImageUrl="~/Imagenes/Aplicacion/iconError.png" />
                                        </td>
                                        <td class="tituloMain">Ha ocurrido un problema inesperado con la aplicación SICAD        
                                        </td>
                                    </tr>
                                </table>
